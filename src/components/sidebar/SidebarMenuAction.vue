...
<template>
  <Primitive
    ...
    :class="cn(
      ...
      showOnHover
        && 'group-focus-within/menu-item:opacity-100 group-hover/menu-item:opacity-100 data-[state=open]:opacity-100 peer-data-[active=true]/menu-button:text-base-100 md:opacity-0',
      props.class,
    )"
    :as="as"
    :as-child="asChild"
