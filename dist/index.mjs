    ...
    return (S, $) => (n(), b(t(Qo), {
      ...
      default: i(() => [
        u(t(Jo), {
          ...
          default: i(() => [
            a.title || a.description || o.header ? (n(), b(t(ar), { key: 0 }, {
              default: i(() => [
                g(S.$slots, "header", {}, () => [
  ...
  setup(a, { emit: l }) {
    ...
    return we(() => $e(e)), ($, O) => (n(), b(t(Ua), {
      ...
      default: i(() => [
        ...
        u(Ld, null, {
          default: i(() => [
            (n(!0), y(X, null, se(z.value, (M, P) => (n(), b(Ed, {
              key: P,
              value: M.rk,
              disabled: M.disabled
            }, {
...
const df = /* @__PURE__ */ Oe(cu, [["render", pu]]), uf = /* @__PURE__ */ v({
  ...
  setup(a, { emit: l }) {
    ...
    function p(D) {
      c.value = D, document.cookie = `${xa}=${c.value}; path=/; max-age=${Jd}`;
    }
    function h(D) {
      f.value = D;
    }
    ...
    Ws("keydown", (D) => {
      D.key === lu && (D.metaKey || D.ctrlKey) && (D.preventDefault(), k());
    });
