...
| Figma 변수 | 의미 / 사용 위치 | upbox-ui 매핑 |
|------------|------------------|---------------|
| `primitive/grey-10` (`#ffffff`) | web 배경 | `bg-grey-10` |
| `border-colour` (`#d3d6de`, = grey-40) | web 보더 | `border-grey-40` |
| `primitive/grey-20` (`#f8f8f9`) | mobile placeholder 배경 | `bg-grey-20` |
| `primitive/blue-20` (`#f5f9ff`) | mobile typed 배경 | `bg-blue-20` |
| `primitive/grey-60` (`#8e94a3`) | placeholder 텍스트 (web·mobile) | `text-grey-60` |
| `primitive/grey-90` (`#303445`) | web typed 텍스트 | `text-grey-90` |
| `CTA/primary` (`#264870`) | mobile typed 텍스트 | `text-cta-primary` |
| `status/processing, informative` (`#0066ff`) | `+N` count 색 | `text-status-informative` |
| `small` (`32`) | chip 높이 | `h-[32px]` |
| `padding/padding-08` / `padding/padding-04` | 외곽 / 본문 padding | `px-[8px] py-[6px]` / `pl-[4px]` |
| 모서리 `4` / full | square / circle | `rounded-[4px]` / `rounded-full` |
| `Body/body5` (12/16, regular) | web 본문 | `text-size-12 leading-[16px] font-normal` |
| `Body/body4-sb` (13/20, semibold) | mobile 본문 | `text-size-13 leading-[20px] font-semibold` |
